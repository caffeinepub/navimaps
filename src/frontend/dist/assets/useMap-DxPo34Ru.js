        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              ...
              onFocus: () => (suggestions.length > 0 || loading || noResults) && setOpen(true),
