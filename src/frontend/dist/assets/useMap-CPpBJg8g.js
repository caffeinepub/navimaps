...
function Layout({ children, className }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-screen w-screen flex flex-col bg-background text-foreground font-body overflow-hidden dark", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Header, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: cn("flex-1 flex overflow-hidden", className), children }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "shrink-0 h-7 flex items-center justify-center bg-card border-t border-border px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
      "© ",
      (/* @__PURE__ */ new Date()).getFullYear(),
      ". Gebouwd met liefde via",
      " ",
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Link,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 rounded-md bg-primary flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                Navigation,
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-semibold text-sm tracking-tight text-foreground hidden sm:block", children: "Navigatie" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-px h-4 bg-border mx-1 hidden sm:block" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "flex items-center gap-1", "aria-label": "Hoofdnavigatie", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            NavLink,
            {
              to: "/",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              to: "/navigeren",
              icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Navigation, { className: "w-3.5 h-3.5" }),
              label: "Navigeren",
              active: isNavPage
            }
          )
        ...
        isNavPage && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Link,
          {
            to: "/",
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Terug naar kaart" })
            ]
          }
        )
      ]
...
function SearchBar({
  ...
  const dropdownMouseDown = reactExports.useRef(false);
  reactExports.useEffect(() => {
    if ((suggestions.length > 0 || loading || noResults) && document.activeElement === inputRef.current) {
      setOpen(true);
    }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn("relative", className), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "shrink-0 text-muted-foreground", children: loading ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-4 h-4 animate-spin text-primary" }) : icon === "origin" ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-4 h-4 rounded-full border-2 border-accent flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-1.5 h-1.5 rounded-full bg-accent" }) }) : icon === "search" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "w-4 h-4" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-4 h-4 text-primary" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              ref: inputRef,
    ...
    error && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-xs text-destructive px-1 fade-up", children: error }),
    showDropdown && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          loading && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5 px-4 py-3 text-sm text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-3.5 h-3.5 animate-spin shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Zoeken…" })
          ] }),
          !loading && suggestions.map((place) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
              onMouseDown: (e) => {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Navigation, { className: "w-4 h-4 mt-0.5 shrink-0 text-primary" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground truncate", children: place.name }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground truncate", children: place.address })
                ] })
              ]
            },
            place.id
          )),
          !loading && noResults && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Geen resultaten gevonden" })
              ]
            }
          )
        ]
...
Service({
  ...
  "geocodeAddress": Func([Text], [Text], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  return IDL2.Service({
    "calculateRoute": IDL2.Func(
      [IDL2.Float64, IDL2.Float64, IDL2.Float64, IDL2.Float64],
      [IDL2.Text],
      []
    ),
    "geocodeAddress": IDL2.Func([IDL2.Text], [IDL2.Text], [])
  });
};
class Backend {
  ...
  async calculateRoute(arg0, arg1, arg2, arg3) {
    if (this.processError) {
      try {
        const result = await this.actor.calculateRoute(arg0, arg1, arg2, arg3);
        return result;
      } catch (e) {
        this.processError(e);
...
function parseNominatimResults(data) {
  return data.map((item) => {
    ...
    return {
      ...
      name: ((_a2 = item.display_name.split(",")[0]) == null ? void 0 : _a2.trim()) ?? item.display_name,
...
function useGeocoding() {
  ...
  const geocode = reactExports.useCallback(
    async (query) => {
      ...
      try {
        ...
        if (actorReady) {
          try {
            const jsonStr = await actor.geocodeAddress(trimmed);
        ...
        setState({
          results: [],
          loading: false,
          error: "Zoeken tijdelijk niet beschikbaar. Controleer uw internetverbinding.",
          noResults: false
        });
        return [];
      }
  ...
  const reverseGeocode = reactExports.useCallback(
    async (coord) => {
      ...
      try {
        ...
        if (!(item == null ? void 0 : item.place_id)) return null;
        return {
          id: String(item.place_id),
          name: ((_a2 = item.display_name.split(",")[0]) == null ? void 0 : _a2.trim()) ?? "Huidige locatie",
          address: formatAddress(item.display_name),
          coordinate: coord
        };
      } catch {
        ...
        try {
          const jsonStr = await actor.geocodeAddress(`${coord.lat},${coord.lng}`);
          const data = JSON.parse(jsonStr);
          const item = Array.isArray(data) ? data[0] : data;
          if (!item) return null;
          return {
            id: String(item.place_id),
            name: ((_b = item.display_name.split(",")[0]) == null ? void 0 : _b.trim()) ?? "Huidige locatie",
            address: formatAddress(item.display_name),
            coordinate: coord
          };
        } catch {
  ...
  const requestLocation = reactExports.useCallback(() => {
    ...
    navigator.geolocation.getCurrentPosition(
      ...
      (err) => {
        ...
        setState({
          ...DEFAULT_AMSTERDAM,
          error: permissionDenied ? "Locatietoegang is uitgeschakeld." : "Kon uw locatie niet bepalen. De kaart toont Amsterdam als standaard locatie.",
          loading: false,
          permissionDenied
        });
      },
...
function useMap(initialCenter) {
  ...
  const setCenter = reactExports.useCallback((center) => {
    setState((prev) => ({ ...prev, center }));
  }, []);
  const setZoom = reactExports.useCallback((zoom) => {
  ...
  const setLayer = reactExports.useCallback((layer) => {
    setState((prev) => ({ ...prev, layer }));
  }, []);
  const selectRoute = reactExports.useCallback((route) => {
    setState((prev) => ({
      ...prev,
      selectedRoute: route,
      activeStepIndex: 0,
  ...
  const setActiveStep = reactExports.useCallback((index) => {
    setState((prev) => {
      var _a2;
      const steps = ((_a2 = prev.selectedRoute) == null ? void 0 : _a2.steps) ?? [];
